...
%    \end{frame}
	...
	\begin{frame}{Energy structure}
		\begin{figure}
			...
			\only<2-3>{\includegraphics[width=0.75\linewidth]{2ion_Elevels.pdf}}
	...
	\begin{frame}{M\o lmer-S\o rensen gate\footfullcite{MS-gate}}
		\centering
		\includegraphics[height=12em]{test.pdf}
	...
	\begin{frame}{Compound gate}
		\centering
		\only<1>{\includegraphics[height=12em]{test.pdf}}
		\only<2>{\includegraphics[height=12em]{Comparison.pdf}}
